...
class VoxelNeXt(Detector3DTemplate):
        ...
        if hasattr(model_cfg,'PREDICTOR'):
            ...
            for localtion_3d_ in model_cfg.PREDICTOR.LOCATION_3D:
                ...
                cur_layer = nn.ModuleList([
                        spconv.SparseMaxPool3d(kernel_size=[pool_3d_kernel_size]*3) if pool_3d_kernel_size>1 else nn.Identity(),
            ...
            # INFO: init the center_head for gt_heatmap gen`
            model_info_dict = {
                'module_list': [],
            ...
            dense_head_module = dense_heads.__all__[self.model_cfg.CENTER_HEAD.NAME](
            ...
            self.center_head = dense_head_module
        else:
            pass
    ...
    def get_gt_heatmap(self, batch_dict, feature_stride=1):
        ...
        dense_head_clone = self.center_head
